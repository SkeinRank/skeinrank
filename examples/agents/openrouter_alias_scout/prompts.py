...
ALIAS_REVIEW_OUTPUT_SCHEMA: JsonDict = {
    ...
    "properties": {
        ...
        "decision_trace": {
            ...
            "description": "Short structured notes about evidence strength, ambiguity, and canonical choice.",
        },
...
def build_alias_review_prompt(candidate_pack: Mapping[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "6. Include decision_trace with compact notes: evidence_strength,",
            "   ambiguity, canonical_choice, and missing_evidence when useful.",
            "7. If canonical_hint has one configured candidate and evidence supports it,",
            "   use that candidate.",
            "8. If known_conflicts are present and evidence does not disambiguate,",
            "   use needs_evidence.",
            "9. Prefer canonical_value/slot from canonical_candidates over free-form guesses.",
            "",
            "Output JSON schema:",
