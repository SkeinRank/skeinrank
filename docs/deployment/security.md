...
and [`../security/prompt-injection-regression-corpus.md`](../security/prompt-injection-regression-corpus.md)
for detector behavior, review semantics, and corpus-backed regression coverage.
