...
- [`benchmarks/headless-agent-workflow.md`](benchmarks/headless-agent-workflow.md) — deterministic 48A/49A benchmark for the headless agent proposal workflow and expanded quality report.
